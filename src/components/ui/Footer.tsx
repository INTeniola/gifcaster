    ...
    <div className="flex justify-around items-center h-14">
      <button
        ...
        className={`flex flex-col items-center justify-center w-full h-full ${
          activeTab === "home" ? 'text-primary dark:text-primary-light' : 'text-gray-500 dark:text-gray-400'
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center w-full h-full ${
          activeTab === "gif" ? 'text-primary dark:text-primary-light' : 'text-gray-500 dark:text-gray-400'
        }`}
      >
